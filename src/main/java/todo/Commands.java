...
public interface Commands {
    ...
    static void printUserCommands() {
        ...
        System.out.println("Please input " + MY_IN_PROGRESS_LIST + " for MY_IN_PROGRESS_LIST EXIT");
        System.out.println("Please input " + MY_FINISHED_LIST + " for MY_FINISHED_LIST EXIT");
